...
Describe "Testing Base Funcionality" {
    $res = Invoke-DockerPester -Image "mcr.microsoft.com/powershell:7.0.0-rc.3-windowsservercore-1803" -InputFolder "$PSScriptRoot/../TestModule/" -PathOnContainer "C:\Temp" -Executor WIN
