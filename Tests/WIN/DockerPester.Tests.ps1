...
Describe "Testing Base Funcionality" {
    $res = Invoke-DockerPester -Image "mcr.microsoft.com/powershell:7.0.0-rc.2-windowsservercore-1809" -InputFolder "$PSScriptRoot/../TestModule/" -PathOnContainer "C" -Executor WIN
