...
Describe "Testing Base Funcionality" {
    $res = Invoke-DockerPester -Image "mcr.microsoft.com/powershell:7.0.0-rc.2-nanoserver-1803" -InputFolder "$PSScriptRoot/../TestModule/" -PathOnContainer "C:/Temp" -Executor WIN
